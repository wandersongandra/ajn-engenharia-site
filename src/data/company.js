export const company = {
  ...
  legalName: 'AJN Consultoria e Engenharia',
  ...
  values: [
    ...
    'Soluções eficazes, inovadoras e sustentáveis',
  ],
  differentials: [
    {
      title: 'Equipe Altamente Qualificada',
      description: 'Profissionais experientes e certificados em todas as áreas de QSSMA.',
    },
    {
      title: 'Comprometimento Ambiental',
      description: 'Práticas sustentáveis integradas a todas as nossas soluções.',
    },
    {
      title: 'Inovação Tecnológica',
      description: 'Uso de tecnologias avançadas para garantir eficiência e precisão.',
    },
    {
      title: 'Atendimento Personalizado',
      description: 'Envolvimento próximo com o cliente — tratamos cada projeto com dedicação familiar.',
    },
  ],
  whatsappMessage: 'Olá! Vim pelo site e gostaria de mais informações sobre os serviços da AJN Engenharia.',
}

export const clientLogos = ['/logos/logo1.jpg', '/logos/logo2.jpg']
